    ...
    private void botaoFinalizarCompraMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botaoFinalizarCompraMouseClicked
        ...
        for (Produto listaDeProduto : listaDeProdutos) {
            ...
            if(inseriu){
                ...
                JOptionPane.showMessageDialog(null, "O sistema retornou um erro insperado com o " + listaDeProduto.getTipo(), "Swerts Store", 0);
            }
        }
        
        JOptionPane.showMessageDialog(null, usuarioOnline.getNome() + ", obrigado por confiar em nossos produtos, volte sempre! ", "Swerts Store", 1);
        dispose();
