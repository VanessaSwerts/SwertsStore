...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        painelTelaLogin.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                painelTelaLoginMouseClicked(evt);
            }
        });
    ...
    private void painelTelaLoginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_painelTelaLoginMouseClicked

    }//GEN-LAST:event_painelTelaLoginMouseClicked
    ...
    private void botaoEntrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botaoEntrarMouseClicked
        ...
        { 
            ...
            {
                JOptionPane.showMessageDialog(null, "Email ou senha incorretos!", "Swerts Store", 2);
            }
        }
    ...
    private void labelEsqueceuSenhaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelEsqueceuSenhaMouseClicked
        JOptionPane.showMessageDialog(null, "Desculpa! Esta opção ainda não está disponível!", "Swerts Store", 2);
