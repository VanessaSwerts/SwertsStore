...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    public TelaPrincipal(Usuario usuario) {
        ...
        // Mostrando JOptionPane para dar boas vindas e fechar ele apos 1.5 segundos caso o usuario nao clique em "Ok"
        mensagemBoasVindas();
    ...
    private void mensagemBoasVindas() {
        ...
        JOptionPane pane = new JOptionPane("Bem-Vindo a Swerts Store!");
        JDialog dialog = pane.createDialog(this, "Conta acessada");
        // Timer para contar os 1.6 segundos
        Timer timer = new Timer(1500,
                new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                dialog.dispose(); // Fechar o  JOptionPane
            }
        });
        timer.setRepeats(false); // Nao repetir o timer
        timer.start(); // Começar a contar
        dialog.show(); // Mostrar o JOptionPane
        timer.stop(); // Parar o timer e fechar o JOptionPane 
    }
    ...
    private void botaoBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botaoBuscarMouseClicked
        ...
        if (listaDeProdutos.isEmpty() == false) {
            ...
            JOptionPane.showMessageDialog(null, "Desculpa, não há produtos com estas características!", "Swerts Store ", 2);
        }
